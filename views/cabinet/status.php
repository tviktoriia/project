...
<html>
   ...
   <body>
      ...
      <div class="container">
         <div class="row">
            <h4>Изменить статус отзыва</h4>
            <form method="post" >
               <button type="submit" name="save" class="btn btn-info">Принять</button>
               <button type="submit" name="not_save" class="btn btn-info">Отклонить</button></br>
            </form>
         </div>
      </div>
      <footer>
